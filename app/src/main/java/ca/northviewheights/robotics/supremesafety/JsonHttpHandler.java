 ...
 */
public class JsonHttpHandler extends TextHttpResponseHandler {
     ...
     */
    public JsonHttpHandler(String encoding) {
        super(encoding);
    }
     ...
     */
    public JsonHttpHandler(boolean useRFC5179CompatibilityMode) {
        super(DEFAULT_CHARSET);
     ...
     * @param useRFC5179CompatibilityMode Boolean mode to use RFC5179 or latest
     */
    public JsonHttpHandler(String encoding, boolean useRFC5179CompatibilityMode) {
        super(encoding);
        this.useRFC5179CompatibilityMode = useRFC5179CompatibilityMode;
    }
    ...
    public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
        ...
        AsyncHttpClient.log.w(LOG_TAG, response.toString());
        HttpUtils.callback(response);
    }
